...
%% Choice of cost_function
% a. 'MSE'
% b. 'cross_entropy'
% c. 'neg_log'

cost_function_set = {'neg_log', 'cross_entropy'};

for costI = 1:2
    cost_function = cost_function_set{costI};

switch cost_function
    case 'neg_log'
        eta_set = 0.2;
        n_hidden_set = 90;
        mini_batch_size_set = 1:10;
        n_epochs = 30;
...
%% Training
for batchnum = 1:numel(mini_batch_size_set)
...
for epochs = 1:n_epochs
    ...
    mini_batch_size = mini_batch_size_set(batchnum);
    ...
    test_results_mlp(test_x, test_y, weights, biases, output_activation);
    clear test_result
end
...
[test_results, accuracy] = test_results_mlp(test_x, test_y, ...
    weights, biases, output_activation);
